    ...
    <app-layout>
        <div class="flex justify-between items-center">
            <div class="flex flex-col text-center justify-center items-center">
                <div class="text-5xl text-indigo-500 font-semibold">
                    Every setup has a story.
                </div>
                <div class="text-xl mt-5 text-gray-400">Tell us yours ...</div>
                <button
                    class="mt-5 font-lighter bg-indigo-500 p-3 rounded text-white w-32 text-center"
                >
                    Share Now
                </button>
            </div>
        ...
        <div class="py-24">
            ...
            <div class="flex justify-center">
                <input
                    type="text"
                    class="mt-8 w-1/3 mx-auto border-0 border-b-2 border-indigo-500 text-xl text-gray-400 text-center py-2 focus:ring-0 outline-none"
                    placeholder="Type something ✎... "
                />
            </div>
            <div class="mt-20 grid md:grid-cols-5 grid-cols-3 gap-4">
                <inertia-link
                    :href="'/'+setup.user.id + '/setup/' + setup.slug"
                    class="shadow transition duration-500 relative p-0 transform hover:scale-105"
                    v-for="setup in setups"
                    :key="setup.id"
                >
                    <img
                        src="https://cdn11.bigcommerce.com/s-fz66rhptih/product_images/uploaded_images/lighting-pc-setup.jpg"
                        class="rounded h-full w-full object-cover"
                    />
                    <div
                        class="absolute bottom-0 right-0 py-1 px-3 bg-indigo-600 text-white font-light text-right"
                    >
                        <div class="text-xs">
                            <span class="font-semibold">by {{setup.user.name}}</span>
                        </div>
                    </div>
                </inertia-link>
            </div>
